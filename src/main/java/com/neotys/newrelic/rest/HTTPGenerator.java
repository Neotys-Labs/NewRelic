...
import static com.neotys.newrelic.rest.HTTPGeneratorUtils.addHeaders;
import static com.neotys.newrelic.rest.HTTPGeneratorUtils.addJsonParameters;
import static com.neotys.newrelic.rest.HTTPGeneratorUtils.generateHttpRequest;
import static com.neotys.newrelic.rest.HTTPGeneratorUtils.newHttpClient;
import static com.neotys.newrelic.rest.HTTPGeneratorUtils.setRequestUrl;
...
public class HTTPGenerator {
	...
	public JSONArray executeAndGetJsonArrayResponse() throws IOException, NewRelicException {
		...
		if (!HttpResponseUtils.isSuccessHttpCode(httpResponse.getStatusLine().getStatusCode())) {
			...
			throw new NewRelicException(httpResponse.getStatusLine().getReasonPhrase() + " - "+ request + " - " + stringResponse);
		}
